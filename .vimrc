...
map <C-t> :tabedit <c-r>=expand("%:p:h")<cr>/
...
" "Map Ctrl+H to toggle Hex editing mode
" map  <C-H> :call ToggleHex()<CR>
" let b:folded = 0
" function! ToggleHex() 
"  if( b:folded == 0 ) 
"      exec ":%!xxd" 
...
" use Ctrl+\ to open current keyword definition in 
" vertical split
map <C-\> :vsp <CR>:exec("tag ".expand("<cword>"))<CR>

" Map F3 to invert search highlight
nnoremap <F3> :set hlsearch!<CR>

" Map F5 to refresh all the buffers
nnoremap <F5> :checktime<CR>

"Map F10 to toggle Taglist editing mode
nnoremap  <F10> :call ToggleTaglist()<CR>
let g:tag_list_open = 0
function! ToggleTaglist() 
  if( g:tag_list_open == 0 ) 
      exec ":TlistOpen" 
      let g:tag_list_open = 1 
  else 
      exec ":TlistClose" 
      let g:tag_list_open = 0 
  endif 
